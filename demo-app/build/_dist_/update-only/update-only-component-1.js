...
export let UpdateOnlyComponent1 = _decorate([customElement('update-only-component-1')], function (_initialize, _observeState) {
  class UpdateOnlyComponent1 extends _observeState {
    constructor(...args) {
      super(...args);
