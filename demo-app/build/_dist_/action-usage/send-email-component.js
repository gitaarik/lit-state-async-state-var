...
export let SendEmailComponent = _decorate([customElement('send-email-component')], function (_initialize, _DemoComponent) {
  ...
  return {
    ...
    d: [{
      ...
      kind: "method",
      key: "handleEmailTextareaKeyup",
      value: function handleEmailTextareaKeyup(event) {
        this.emailText = event.target.value;
      }
    }, {
      kind: "method",
      key: "handleSendEmailButtonClick",
      value: function handleSendEmailButtonClick() {
