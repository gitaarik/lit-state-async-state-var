...
import './send-email-component.js';
import './send-email-status-component.js';
export let ActionUsage = _decorate([customElement('action-usage')], function (_initialize, _LitDocsContent) {
  class ActionUsage extends _LitDocsContent {
    constructor(...args) {
      super(...args);
...
export const demoState = new DemoState();`;
      ...
      kind: "get",
      key: "sendEmailComponentCode",
      value: function sendEmailComponentCode() {
...
export class SendEmailComponent extends LitElement {
    ...
    handleSendEmailButtonClick() {
      ...
      kind: "get",
      key: "sendEmailStatusComponentCode",
      value: function sendEmailStatusComponentCode() {
