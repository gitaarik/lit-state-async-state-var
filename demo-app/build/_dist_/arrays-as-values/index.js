...
import './array-component.js';
export let ArraysAsValues = _decorate([customElement('arrays-as-values')], function (_initialize, _LitDocsContent) {
  class ArraysAsValues extends _LitDocsContent {
    constructor(...args) {
      super(...args);
