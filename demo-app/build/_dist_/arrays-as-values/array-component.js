...
export let ArrayComponent = _decorate([customElement('array-component')], function (_initialize, _observeState) {
  class ArrayComponent extends _observeState {
    constructor(...args) {
      super(...args);
