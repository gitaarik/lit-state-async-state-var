...
export let DelayedPushComponent2 = _decorate([customElement('delayed-push-component-2')], function (_initialize, _observeState) {
  class DelayedPushComponent2 extends _observeState {
    constructor(...args) {
      super(...args);
