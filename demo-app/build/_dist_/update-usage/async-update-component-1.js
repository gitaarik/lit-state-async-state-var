...
export let AsyncUpdateComponent1 = _decorate([customElement('async-update-component-1')], function (_initialize, _observeState) {
  class AsyncUpdateComponent1 extends _observeState {
    constructor(...args) {
      super(...args);
